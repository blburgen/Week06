 ...
 * - Deck
 * - Player
 * 2.  You will create an application class, App, which has a main method and which will use the classes created above to accomplish the goal of this 
 * 		project, instantiating each of the objects as needed.  We suggest one Deck, with 52 Cards, and 2 Players.  Remember to create getters, 
 * 		setters and constructors for each of these.
 * 3.  As your Final Java Project, this assignment will be written in Java, and will use much of what you have learned so far, including variables, 
 * 		loops, methods, classes, instantiation of objects, and more.
 ...
 *		Compare the value of each card returned by the two player’s flip methods. Call the incrementScore method on the player whose card has the 
 *			higher value.  Print a message to say which player received a point.
